...
public class BillManagement extends javax.swing.JFrame {
   ...
   private TotalPrice t;
    ...
    public BillManagement() {		// displays bill payement page
        initComponents();
    ...
    public void display(){			// displays list and price of items
         t = new TotalPrice();
         it = new inTotal();
    ...
    //clears payement of food and deletes the items form invertory.
